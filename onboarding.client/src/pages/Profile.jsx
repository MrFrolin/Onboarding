...
export default function Profile() {
  const userStateLocalStorage = localStorage.getItem("User");
  const employee = JSON.parse(userStateLocalStorage);

  return (
    <div>
      <Navigation />
      <div class="bg-white w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931] pt-16 container mx-auto">
